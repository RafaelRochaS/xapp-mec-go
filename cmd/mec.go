...
func (e *MECApp) getEnbList() ([]*xapp.RNIBNbIdentity, error) {
...
func (e *MECApp) getGnbList() ([]*xapp.RNIBNbIdentity, error) {
...
func (e *MECApp) getnbList() []*xapp.RNIBNbIdentity {
...
func (e *MECApp) sendSubscription(meid string) {
